...
public class UncheckedExecutionException extends RuntimeException {
   ...
   *
   * @deprecated Prefer {@code UncheckedExecutionException(Throwable)} a constructor that
   ...
   *     anyone from calling {@code #initCause} later, so it is not quite equivalent to using a
   ...
   *
   * @deprecated Prefer {@code UncheckedExecutionException(String, Throwable)} a constructor
