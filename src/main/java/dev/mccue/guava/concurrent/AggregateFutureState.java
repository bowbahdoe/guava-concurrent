...
import static dev.mccue.guava.collect.Sets.newConcurrentHashSet;
...
abstract class AggregateFutureState<OutputT extends @Nullable Object>
  ...
  private static final Logger log = System.getLogger(AggregateFutureState.class.getName());
  ...
  static {
    ...
    if (thrownReflectionFailure != null) {
      log.log(Level.ERROR, "SafeAtomicHelper is broken!", thrownReflectionFailure);
    }
  }
